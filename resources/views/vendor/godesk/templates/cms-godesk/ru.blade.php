            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="heading text-center">
                        <h1 class="text-light">{!! str_replace('Система', '<span class="text-primary">Система</span>', $entity->title) !!}</h1>
                        <p>Создано для людей и разработчиков. <br>На основе Laravel Framework.</p>
                        <div class="buttons">
{{--                            <a href="{!! get_setting('website_social')->youtube !!}" class="btn btn-primary">Видео</a>--}}
                            <div class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" data-type="danger" title="Канал в разработке">Видео</div>
                            <a href="{{ GoDesk::urlById('page', 8, $entity->locale) }}" class="btn btn-outline-light">Документация</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="item col-lg-3 col-sm-6">
                    <div class="card">
                        <img class="card-img-top" src="{{ GoDesk::image('website/godesk/for/easy.png') }}" alt="Всё что нужно">
                        <div class="card-body">
                            <h3 class="card-title h5">Всё что нужно</h3>
                            <p class="card-text">Мы стараемся построить то, что вам действительно нужно. Админка вашего приложения не должна быть устарелой.</p>
                        </div>
                    </div>
                </div>
                <div class="item col-lg-3 col-sm-6">
                    <div class="card">
                        <img class="card-img-top" src="{{ GoDesk::image('website/godesk/for/project.png') }}" alt="Любые задачи">
                        <div class="card-body">
                            <h3 class="card-title h5">Любые задачи</h3>
                            <p class="card-text">GoDesk предоставляет вам полный интерфейс для ваших моделей Eloquent. Все типы отношений Eloquent полностью поддерживаются.</p>
                        </div>
                    </div>
                </div>
                <div class="item col-lg-3 col-sm-6">
                    <div class="card">
                        <img class="card-img-top" src="{{ GoDesk::image('website/godesk/for/clean.png') }}" alt="Чистый код">
                        <div class="card-body">
                            <h3 class="card-title h5">Чистый код</h3>
                            <p class="card-text">GoDesk - отличное приложение, основанное на Laravel Framework. Разработка пользовательских компонентов теперь проста.</p>
                        </div>
                    </div>
                </div>
                <div class="item col-lg-3 col-sm-6">
                    <div class="card">
                        <img class="card-img-top" src="{{ GoDesk::image('website/godesk/for/cheers.png') }}" alt="Всем привет">
                        <div class="card-body">
                            <h3 class="card-title h5">Всем привет!</h3>
                            <p class="card-text">Вы оцените все преимущества системы. Ничего лишнего, просто качественная система управления контентом.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="built-for section">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-7">
                    <img class="main" src="{{ GoDesk::image('website/godesk/built-for/storm.jpg') }}" alt="Инструменты с открытым исходным кодом">
                </div>
                <div class="col-lg-5">
                    <div class="heading">
                        <h2 class="h3">Разработано с помощью хорошо известных инструментов с открытым исходным кодом</h2>
                        <p>В GoDesk мы используем хорошо известные библиотеки с открытым исходным кодом, такие как Vue.js, которые делают жизнь проще для всех.</p>
                    </div>
                    <a href="{{ GoDesk::urlById('page', 8, $entity->locale) }}" class="btn btn-primary">Документация</a>
                    <div class="images">
...
{{--                        <img src="{{ GoDesk::image('website/godesk/github_logo.png') }}" alt="spacecode-dev/godesk">--}}
                        <h2 class="h3">Открытый исходный код</h2>
                        <p>На данный момент CMS GoDesk - это 100% открытый и бесплатный код, мы рады поделиться им с разработчиками по всему миру.</p>
                    </div>
                    <a href="{!! Auth::check() ? route('profile') : route('profile', ['lang' => $entity->locale]) !!}" class="btn btn-primary" target="_blank" rel="nofollow">Посмотреть</a>
                </div>
                <div class="col-lg-6 order-lg-1 order-0">
                    <img class="main" src="{{ GoDesk::image('website/godesk/profile.png') }}" alt="CMS для Laravel 7.*">
                </div>
            </div>
        </div>
    </div>
