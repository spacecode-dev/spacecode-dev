            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="heading text-center">
                        ...
                        <p>Створено для людей і розробників. <br>На основі Laravel Framework.</p>
                        <div class="buttons">
{{--                            <a href="{!! get_setting('website_social')->youtube !!}" class="btn btn-primary">Видео</a>--}}
                            <div class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" data-type="danger" title="Канал в розробці">Відео</div>
                            <a href="{{ GoDesk::urlById('page', 8, $entity->locale) }}" class="btn btn-outline-light">Документація</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="item col-lg-3 col-sm-6">
                    <div class="card">
                        <img class="card-img-top" src="{{ GoDesk::image('website/godesk/for/easy.png') }}" alt="Все що потрібно">
                        <div class="card-body">
                            <h3 class="card-title h5">Все що потрібно</h3>
                            <p class="card-text">Ми намагаємося побудувати те, що вам дійсно потрібно. Адмінка вашого веб додатку не повинна бути застарілою.</p>
                        </div>
                    </div>
                </div>
                <div class="item col-lg-3 col-sm-6">
                    <div class="card">
                        <img class="card-img-top" src="{{ GoDesk::image('website/godesk/for/project.png') }}" alt="Будь-які завдання">
                        <div class="card-body">
                            <h3 class="card-title h5">Будь-які завдання</h3>
                            <p class="card-text">GoDesk надає вам повний інтерфейс для ваших моделей Eloquent. Всі типи відносин Eloquent повністю підтримуються.</p>
                        </div>
                    </div>
                </div>
                <div class="item col-lg-3 col-sm-6">
                    <div class="card">
                        <img class="card-img-top" src="{{ GoDesk::image('website/godesk/for/clean.png') }}" alt="Чистий код">
                        <div class="card-body">
                            <h3 class="card-title h5">Чистий код</h3>
                            <p class="card-text">GoDesk - відмінний додаток, заснований на Laravel Framework. Розробка компонентів для користувача тепер проста.</p>
                        </div>
                    </div>
                </div>
                <div class="item col-lg-3 col-sm-6">
                    <div class="card">
                        <img class="card-img-top" src="{{ GoDesk::image('website/godesk/for/cheers.png') }}" alt="Всім привіт">
                        <div class="card-body">
                            <h3 class="card-title h5">Всім привіт!</h3>
                            <p class="card-text">Ви оціните всі переваги системи. Нічого зайвого, просто якісна система управління контентом.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="built-for section">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-7">
                    <img class="main" src="{{ GoDesk::image('website/godesk/built-for/storm.jpg') }}" alt="Інструменти з відкритим вихідним кодом">
                </div>
                <div class="col-lg-5">
                    <div class="heading">
                        <h2 class="h3">Розроблено за допомогою добре відомих інструментів з відкритим вихідним кодом</h2>
                        <p>У GoDesk ми використовуємо добре відомі бібліотеки з відкритим вихідним кодом, такі як Vue.js, які роблять життя простіше для всіх.</p>
                    </div>
                    <a href="{{ GoDesk::urlById('page', 8, $entity->locale) }}" class="btn btn-primary">Документація</a>
                    <div class="images">
...
{{--                        <img src="{{ GoDesk::image('website/godesk/github_logo.png') }}" alt="spacecode-dev/godesk">--}}
                        <h2 class="h3">Відкритий вихідний код</h2>
                        <p>На даний момент CMS GoDesk - це 100% відкритий і безкоштовний код, ми раді поділитися ним з розробниками по всьому світу.</p>
                    </div>
                    <a href="{!! Auth::check() ? route('profile') : route('profile', ['lang' => $entity->locale]) !!}" class="btn btn-primary" target="_blank" rel="nofollow">Подивитися</a>
                </div>
