            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-12">
                    <div class="heading text-center">
                        <p class="pre h6">Никаких скрытых платежей</p>
                        <h1>Справедливые цены, соответствующие вашим потребностям</h1>
                        <p>Простое и прозрачное ценообразование для всех. Никаких неожиданных дополнительных платежей.</p>
                    </div>
                </div>
