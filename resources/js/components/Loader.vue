...
<script>
import validateDuration from './Loader/validateDuration.js';
import calcPropertyValue from './Loader/calcPropertyValue.js';
  ...
  methods: {
    ...
    moon(pos, variant) {
      ...
      return {
        width: `${size}px`,
        height: `${size}px`,
        transform: `translate(calc(-50% ${transformCalc} ${transform}px), -50%)`,
      }
    },
  },
}
