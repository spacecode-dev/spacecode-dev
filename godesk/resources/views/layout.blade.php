        ...
        <div v-cloak class="flex min-h-screen">
            ...
            <div class="min-h-screen flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar px-6">
                <a href="{{ \Laravel\Nova\Nova::path() }}">
                    <div class="theme-logo absolute pin-t pin-l pin-r bg-logo flex items-center w-sidebar h-header px-6 text-white">
                       @include('godesk::partials.logo', ['width' => 22, 'margin' => 'mr-3', 'fill' => '#ffffff'])
                    </div>
                </a>
            ...
            <div class="content">
                <div class="flex items-center relative shadow h-header bg-white z-20 px-view">
                    <a v-if="@json(env('APP_NAME') !== null)" href="{{ \Illuminate\Support\Facades\Config::get('nova.url') }}" target="_blank" class="no-underline dim font-bold text-90 mr-6">
                        {{ env('APP_NAME') }}
                    </a>
                ...
                <div data-testid="content" class="px-view py-view mx-auto">
                    ...
                    @include('godesk::partials.footer')
                </div>
            </div>
        </div>
    </div>
