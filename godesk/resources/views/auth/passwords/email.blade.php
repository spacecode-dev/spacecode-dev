@extends('godesk::auth.layout')

@section('content')

@include('godesk::auth.partials.header')

<form class="bg-white shadow rounded-lg p-8 max-w-login mx-auto" method="POST" action="{{ route('nova.password.email') }}">
    {{ csrf_field() }}
