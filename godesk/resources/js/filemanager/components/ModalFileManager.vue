                        ...
                        <div class="p-3 flex flex-wrap items-center border-b border-50">
                            ...
                            <div class="w-auto flex flex-1 flex-wrap justify-end">
                                ...
                                <div class="relative w-1/2 max-w-xs">
                                    <div class="relative">
                                        <div class="relative">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-labelledby="search" role="presentation"
                                            ...
                                            <input v-on:input="searchItems" v-model="search" dusk="filemanager-search" type="search" :placeholder="this.__('Search')"
...
export default {
    ...
    created() {
        if (localStorage.getItem('godesk-filemanager-view')) {
            const view = localStorage.getItem('godesk-filemanager-view');
